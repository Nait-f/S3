...
import ru.samsung.gamestudio.objects.StarObject;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
        for (StarObject star : starArray) star.draw(myGdxGame.batch);
        shipObject.draw(myGdxGame.batch);
//////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void updateStar() {
        for (int i = 0; i < starArray.size(); i++) {
            ...
            StarObject starObject = starArray.get(i);
            boolean hasToBeDestroyed = !starObject.isAlive() || !starObject.isInFrame();

            if (!starObject.isAlive()) {
                if (myGdxGame.audioManager.isSoundOn) myGdxGame.audioManager.explosionSound.play(0.2f);
                gameSession.score += 50;
            }

            if (hasToBeDestroyed) {
                myGdxGame.world.destroyBody(starObject.body);
                starArray.remove(i--);
            }
        }
    }
